...
let blobsManifest
try {
  blobsManifest = new Set(require("../../../.next/blobs-manifest.json"))
} catch {}
const path = require("path");
const pageRoot = path.resolve(path.join(__dirname, "../../../.next", "server"));
exports.handler = builder((({ conf, app, pageRoot, NextServer, staticManifest = [], blobsManifest = new Set(), mode = 'ssr', useHooks, }) => {
    var _a;
